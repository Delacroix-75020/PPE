<?php
function requete_et($p_motscles){


global $bdd;
$requete = $bdd->prepare("SELECT * FROM produit");
$requete_ou = $bdd->prepare($requete_et);
$requete_et = $bdd->prepare("WHERE p_motscles LIKE '%".$chaque_mot."%' ");
$requete_ou = $bdd->prepare("WHERE p_motscles LIKE '%".$chaque_mot."%' ");
$requete_et = $bdd->prepare("AND p_motscles LIKE '%".$chaque_mot."%' ");  
$requete_ou = $bdd->prepare("OR p_motscles LIKE '%".$chaque_mot."%' ");
 $requete_et = $bdd->prepare("LIMIT 0,10;");
