...
$selAccessoires = getlesAccessoires($bdd);
                    foreach ($selAccessoires as $produit) {
...
<html>
  ...
  <body>
    ...
    <div class="container">
      ...
      <br /><br />
      <?php
        $query =  "SELECT * FROM produit  LEFT JOIN image ON produit.id_image = image.id_image where id_categorie=2 ORDER BY id_produit ASC";
